...
class Pyramidal51Autoencoder(nn.Module):
    """Basic pyramidal autoencoder: 5 levels, 1 convs/level"""
    ...
    def __init__(self, num_channels_provider, activation_factory):
        ...
        self.dec4 = TransposeConvBlock(channels_4, channels_3, 3, 2, 1, 1, activation_factory)
        self.dec3 = TransposeConvBlock(channels_3, channels_2, 3, 2, 1, 1, activation_factory)
        self.dec2 = TransposeConvBlock(channels_2, channels_1, 3, 2, 1, 1, activation_factory)
        self.dec1 = TransposeConvBlock(channels_1, channels_0, 3, 2, 1, 1, activation_factory)
        self.dec0 = OutputBlock(channels_0, 3, 3, 1, 1)
